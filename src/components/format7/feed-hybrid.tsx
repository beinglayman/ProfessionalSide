...
const FeedHybrid: React.FC<FeedHybridProps> = ({ entry, showUserProfile = true }) => {
  ...
  return (
    <div className="w-full">
      {/* Entry Title */}
      <div className="mb-6">
        <h3 className="text-sm font-semibold text-gray-500 mb-2">Feed View: Hybrid (Compact Header + Outlined Body)</h3>
      </div>

      {/* Card with hover shadow */}
      <div className="rounded-lg border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-md">
        {/* Compact Author Header (from Compact Feed) */}
        {showUserProfile && (
        ...
        {/* Main Content (from Outlined Minimal) */}
        <div className="p-6">
