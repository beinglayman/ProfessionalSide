export const evidencePrototypes = [
  { id: 'v1', name: 'Inline Evidence Cards', file: 'proto-V1-inline-evidence.html' },
  { id: 'v2', name: 'Split Panel', file: 'proto-V2-split-panel.html' },
  { id: 'v3', name: 'Accordion Stack', file: 'proto-V3-accordion-stack.html' },
  ...
  { id: 'v10', name: 'Dashboard Cards', file: 'proto-V10-dashboard-cards.html' },
];
