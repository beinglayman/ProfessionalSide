...
const ToolSVGs: Partial<Record<ToolType, React.ReactNode>> = {
  ...
  teams: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-[65%] h-[65%]">
      <path d="M20.625 8.5h-1.5A2.625 2.625 0 0121.75 11v4a2.625 2.625 0 01-2.625 2.625H17.25a4.243 4.243 0 01-1.5 3.244V21a2.75 2.75 0 002.75 2.75h.25A2.75 2.75 0 0021.5 21v-4.375h1.125A1.375 1.375 0 0024 15.25V9.875A1.375 1.375 0 0022.625 8.5h-2zM21 6.25a2.25 2.25 0 10-4.5 0 2.25 2.25 0 004.5 0zM14.788 7H7.212A2.212 2.212 0 005 9.212v5.463a5.462 5.462 0 003.5 5.1V21a2.75 2.75 0 002.75 2.75h.5A2.75 2.75 0 0014.5 21v-1.225a5.462 5.462 0 003.5-5.1V9.212A2.212 2.212 0 0014.788 7zM11 4.75a3.25 3.25 0 10-6.5 0 3.25 3.25 0 006.5 0z"/>
    </svg>
  ),
  onedrive: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-[65%] h-[65%]">
      <path d="M10.07 7.2a5.95 5.95 0 014.14 1.67A4.74 4.74 0 0116 8.72a4.82 4.82 0 014.82 4.82c0 .15-.01.3-.03.44A3.65 3.65 0 0124 17.46a3.67 3.67 0 01-3.67 3.67H6.2a6.2 6.2 0 01-6.2-6.2c0-2.85 1.93-5.25 4.55-5.97A5.97 5.97 0 0110.07 7.2z"/>
    </svg>
  ),
  sharepoint: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-[65%] h-[65%]">
      <path d="M12.47 7.28c3.07 0 5.56 2.49 5.56 5.56s-2.49 5.56-5.56 5.56c-1.07 0-2.07-.3-2.92-.83a7.18 7.18 0 001.81-1.73c.36.12.73.18 1.11.18a3.18 3.18 0 000-6.36 3.15 3.15 0 00-2.53 1.26 7.27 7.27 0 00-2.35-.72 5.54 5.54 0 014.88-2.92zM7.2 9.96a5.56 5.56 0 105.55 5.56A5.56 5.56 0 007.2 9.96zm0 2.38a3.18 3.18 0 110 6.36 3.18 3.18 0 010-6.36z"/>
    </svg>
  ),
};
