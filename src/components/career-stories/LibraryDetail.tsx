...
import { ArrowLeft, Copy, Check, MoreHorizontal, Trash2, RefreshCw, Info, ExternalLink } from 'lucide-react';
...
import { DERIVATION_COLOR_CLASSES } from './constants';
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
export function LibraryDetail({ item, allStories, onBack, onDelete, onRegenerate, onNavigateToStory }: LibraryDetailProps) {
  ...
  // Step 1: Resolve parent story sources
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Document card — matches NarrativePreview visual language */}
      <article className="relative bg-white rounded-xl border border-gray-200/80 shadow-sm overflow-hidden flex-1 flex flex-col">
        {/* Header */}
        ...
        {/* Content area — with optional source margin on desktop */}
        <div className="px-6 pb-4 flex-1 overflow-y-auto">
          <div className="flex gap-0">
            ...
            {/* Source margin — desktop only, read-only (no exclude) */}
