...
import { profilePrototypes } from '../../components/profile-prototypes';
import { cn } from '../../lib/utils';

type DesignId = string;

export function ProfilePrototypesPage() {
  const [activeDesign, setActiveDesign] = useState<DesignId>(profilePrototypes[0].id);
  const currentDesign = profilePrototypes.find((d) => d.id === activeDesign)!;
      ...
      <div className="mx-auto max-w-[1600px] px-4 py-8 sm:px-6">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500">
            10 different design approaches for the Profile page — click to switch
          </p>
        </div>

        {/* Design Switcher */}
        <div className="mb-8 flex flex-wrap gap-2">
          {profilePrototypes.map((design) => {
