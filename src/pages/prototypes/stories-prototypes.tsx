...
import { storiesPrototypes } from '../../components/stories-prototypes';
import { cn } from '../../lib/utils';

type DesignId = string;

export function StoriesPrototypesPage() {
  const [activeDesign, setActiveDesign] = useState<DesignId>(storiesPrototypes[0].id);
  const currentDesign = storiesPrototypes.find((d) => d.id === activeDesign)!;
      ...
      <div className="mx-auto max-w-[1600px] px-4 py-8 sm:px-6">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold tracking-tight text-gray-900">
            Career Stories Page Prototypes
          </h1>
          <p className="mt-1 text-sm text-gray-500">
            10 different design approaches for the Career Stories page — click to switch
          </p>
        </div>

        {/* Design Switcher */}
        <div className="mb-8 flex flex-wrap gap-2">
          {storiesPrototypes.map((design) => {
