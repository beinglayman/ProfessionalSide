...
CREATE TABLE "mcp_audit_logs" (
    ...
    "dataCleared" BOOLEAN NOT NULL DEFAULT true,
    "itemCount" INTEGER,
...
-- CreateTable
CREATE TABLE "mcp_daily_summary_preferences" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "mcp_daily_summary_preferences_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "mcp_integrations_userId_idx" ON "mcp_integrations"("userId");

-- CreateIndex
CREATE INDEX "mcp_integrations_toolType_idx" ON "mcp_integrations"("toolType");

-- CreateIndex
CREATE UNIQUE INDEX "mcp_integrations_userId_toolType_key" ON "mcp_integrations"("userId", "toolType");

-- CreateIndex
CREATE INDEX "mcp_audit_logs_userId_idx" ON "mcp_audit_logs"("userId");

-- CreateIndex
CREATE INDEX "mcp_audit_logs_integrationId_idx" ON "mcp_audit_logs"("integrationId");

-- CreateIndex
CREATE INDEX "mcp_audit_logs_action_idx" ON "mcp_audit_logs"("action");

-- CreateIndex
CREATE INDEX "mcp_audit_logs_createdAt_idx" ON "mcp_audit_logs"("createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "mcp_daily_summary_preferences_userId_key" ON "mcp_daily_summary_preferences"("userId");
...
-- AddForeignKey
ALTER TABLE "mcp_integrations" ADD CONSTRAINT "mcp_integrations_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "mcp_audit_logs" ADD CONSTRAINT "mcp_audit_logs_integrationId_fkey" FOREIGN KEY ("integrationId") REFERENCES "mcp_integrations"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mcp_daily_summary_preferences" ADD CONSTRAINT "mcp_daily_summary_preferences_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
