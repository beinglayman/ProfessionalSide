...
export const NARRATIVE_FRAMEWORKS: Record<NarrativeFrameworkType, NarrativeFrameworkUIDefinition> = {
  ...
  SOAR: {
    type: 'SOAR',
    name: 'SOAR',
    tagline: 'Objective-driven for business impact',
    description: 'Situation-Objective-Action-Result. Emphasizes goals and business alignment. Great for PM and leadership roles.',
    componentOrder: ['situation', 'objective', 'action', 'result'],
    ...
    componentDefinitions: [
      ...
      },
      {
        name: 'objective',
        label: 'Objective',
        description: 'The goal you set',
        prompt: 'What specific, measurable goal did you set?',
      },
      {
        name: 'action',
        label: 'Action',
        description: 'How you achieved it',
        prompt: 'What strategy and actions did you take?',
      },
      {
        name: 'result',
        label: 'Result',
        description: 'Business impact',
        prompt: 'Did you hit the objective? What was the business impact?',
      },
    ],
    ...
    example: {
      ...
      components: [
        ...
        {
          name: 'objective',
          text: 'Increase 30-day retention by 10% within one quarter through a new onboarding flow.',
        },
        {
          name: 'action',
  ...
  SHARE: {
    ...
    description: 'Situation-Hindsight-Action-Result-Example. Emphasizes reflection and collaboration. Good for leadership roles.',
    componentOrder: ['situation', 'hindsight', 'action', 'result', 'example'],
    ...
    componentDefinitions: [
      ...
      },
      {
        name: 'hindsight',
        label: 'Hindsight',
        description: 'What you realized',
        prompt: 'What insight or realization did you have?',
      },
      {
        name: 'action',
        label: 'Action',
        description: 'What you did',
        prompt: 'How did you act on that insight?',
      },
      {
        name: 'result',
        label: 'Result',
        description: 'The outcome',
        prompt: 'What was the team/organizational outcome?',
      },
      {
        name: 'example',
        label: 'Example',
        description: 'A specific instance',
        prompt: 'Give a concrete example that illustrates this.',
      },
    ],
    ...
    example: {
      ...
      components: [
        ...
        {
          name: 'hindsight',
          text: 'I realized our postmortem culture was blame-focused, making people afraid to fail.',
        },
        {
          name: 'action',
        ...
        {
          name: 'example',
          text: 'One engineer proposed a caching approach everyone thought was too risky. With the new culture, we tried it and reduced costs by 40%.',
        },
      ],
    },
