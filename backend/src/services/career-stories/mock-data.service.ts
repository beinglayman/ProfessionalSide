...
export function generateMockActivities(): ActivityInput[] {
  ...
  return [
    ...
    // GitHub commits for the auth PR
    {
      source: 'github',
      sourceId: 'commit:a1b2c3d',
      sourceUrl: 'https://github.com/acme/backend/commit/a1b2c3d4567890',
      title: 'feat(auth): add OAuth2 provider configuration',
      description: 'feat(auth): add OAuth2 provider configuration\n\nAdds configuration for Google, GitHub, and Microsoft OAuth providers.\nIncludes client ID/secret management and callback URL handling.\n\nRelated to AUTH-123',
      ...
      rawData: {
        ...
        deletions: 10,
        filesChanged: 5,
        message: 'feat(auth): add OAuth2 provider configuration\n\nAdds configuration for Google, GitHub, and Microsoft OAuth providers.\nIncludes client ID/secret management and callback URL handling.\n\nRelated to AUTH-123',
      },
    },
    {
      source: 'github',
      sourceId: 'commit:e4f5g6h',
      sourceUrl: 'https://github.com/acme/backend/commit/e4f5g6h7890123',
      title: 'feat(auth): implement token refresh logic',
      description: 'feat(auth): implement token refresh logic\n\nImplements automatic token refresh with exponential backoff.\nHandles token expiration gracefully.',
      ...
      rawData: {
        ...
        deletions: 15,
        filesChanged: 3,
        message: 'feat(auth): implement token refresh logic\n\nImplements automatic token refresh with exponential backoff.\nHandles token expiration gracefully.',
      },
    },
